...
def setting():
    print('\033[0;92m=============================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] 𝐁𝐎𝐑𝐀 \x1b[33m[1\x1b[33m] \x1b[33m[\033[0;92mOLD \x1b[36mID\x1b[33m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] 𝐁𝐎𝐑𝐀 \x1b[33m[2\x1b[33m] \x1b[33m[\033[0;92mNEW \x1b[36mID\x1b[33m]")
    print("\033[97;1m[\033[92;1m3\033[97;1m] 𝐁𝐎𝐑𝐀 \x1b[33m[3\x1b[33m] \x1b[33m[\033[0;92mMIX \x1b[36mID\x1b[33m]")
    print('\033[0;92m=============================')
...
def passwrd():
    print("")
    print("\033[97;1m[\033[92;1m➢\033[97;1m] 𝗕𝗢𝗥𝗔 \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mTODAY \x1b[36mDATE\x1b[33m] :\033[1;92m "+date)
    print('\033[97;1m[\033[92;1m➢\033[97;1m] 𝗕𝗢𝗥𝗔 \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mTOTAL \x1b[36mID\x1b[33m] : ',str(len(id)))
    print("\033[97;1m[\033[92;1m➢\033[97;1m] 𝗕𝗢𝗥𝗔 \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mTODAY \x1b[36mTIME\x1b[33m] : \033[1;92m"+time.strftime("%H:%M")+" "+ tag)
    print("\033[97;1m[\033[92;1m➢\033[97;1m] 𝗕𝗢𝗥𝗔 \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mSTART \x1b[36mCRACKING\x1b[33m]")
    print('\033[0;96m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[32m{bo}\x1b[33m[𝗕𝗢𝗥𝗔\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m] \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK\x1b[30m/\x1b[36mCP\x1b[33m]{bo} \x1b[32m{ok} / \x1b[36m{cp} \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]\033[0;36m "),
    sys.stdout.flush()
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}\x1b[33m[\x1b[32m𝗕𝗢𝗥𝗔\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m]{P} \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK/\x1b[36mCP\x1b[33m] \x1b[33m[\x1b[32m{ok}/\x1b[36m{cp}\x1b[33m] \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def cek_NIK(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              𝗔𝗽𝗽 𝗔𝗰𝘁𝗶𝘃𝗲➛ %s%s"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              𝗔𝗽𝗽𝗘𝘅𝗽𝗶𝗿𝗲➛ %s"%(P,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
